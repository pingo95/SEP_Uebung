...
public:
  ...
  */
  ...
  explicit QCustomPlot(QWidget *parent = 0, bool sorted = true);
  virtual ~QCustomPlot();
...
// change by Towara: add support for unsorted Points
typedef QList<QCPData> QCPUnsortedDataMap;
...
public:
  ...
  */
  ...
  explicit QCPGraph(QCPAxis *keyAxis, QCPAxis *valueAxis, bool sorted = true);
  virtual ~QCPGraph();
...
protected:
  ...
  // change by Towara: add support for unsorted Points
  bool drawSorted;
  QCPUnsortedDataMap *mUnsortedData;
